...
do
    ...
    #bash qsub.sh $dataset_path $dataset_name 11-rs0 \
    ...
    #bash qsub.sh $dataset_path $dataset_name 11-rs100k \
    ...
    #bash qsub.sh $dataset_path $dataset_name 11-rs500k \
