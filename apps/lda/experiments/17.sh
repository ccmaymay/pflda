...
do
    ...
    bash qsub.sh $dataset_path $dataset_name 17-rs0 \
    ...
    bash qsub.sh $dataset_path $dataset_name 17-rs100k \
    ...
    bash qsub.sh $dataset_path $dataset_name 17-rs500k \
