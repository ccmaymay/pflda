...
dataset_path=../../data/txt/tng-noheader-nowalls-nonalpha.3
...
do
    ...
    bash qsub.sh $dataset_path $dataset_name 20-rs0 \
    ...
    bash qsub.sh $dataset_path $dataset_name 20-rs100k \
    ...
    bash qsub.sh $dataset_path $dataset_name 20-rs500k \
