...
plot.experiments('1', c('diff3', 'rel3', 'sim3'), c('1-rs0', '1-rs100', '1-rs1k', '1-rs10k', '1-rs100k', '1-rs500k'), c('no rejuvenation', 'reservoir size 100', 'reservoir size 1k', 'reservoir size 10k', 'reservoir size 100k', 'reservoir size 500k'))
...
plot.experiments('17', c('diff3', 'rel3', 'sim3'), c('17-rs0', '17-rs100', '17-rs1k', '17-rs10k', '17-rs100k', '17-rs500k'), c('reservoir size 0', 'reservoir size 100', 'reservoir size 1k', 'reservoir size 10k', 'reservoir size 100k', 'reservoir size 500k'))
