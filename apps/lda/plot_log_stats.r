...
plot.experiments('28', c('diff3'), c('28-rs50000-rss5000', '28-rs100000-rss10000', '28-rs500000-rss50000'), c('reservoir size 50k', 'reservoir size 100k', 'reservoir size 500k'), c('in_sample_nmi', 'out_of_sample_nmi'), c('in-sample NMI', 'out-of-sample NMI'))
#plot.experiments('29-a0.001', c('diff3'), c('29-a0.001-b0.001', '29-a0.001-b0.01', '29-a0.001-b0.1', '29-a0.001-b1', '29-a0.001-b10'), c('alpha 0.001, beta 0.001', 'alpha 0.001, beta 0.01', 'alpha 0.001, beta 0.1', 'alpha 0.001, beta 1', 'alpha 0.001, beta 10'), c('in_sample_nmi', 'out_of_sample_nmi'), c('in-sample NMI', 'out-of-sample NMI'))
#plot.experiments('29-a0.01', c('diff3'), c('29-a0.01-b0.001', '29-a0.01-b0.01', '29-a0.01-b0.1', '29-a0.01-b1', '29-a0.01-b10'), c('alpha 0.01, beta 0.001', 'alpha 0.01, beta 0.01', 'alpha 0.01, beta 0.1', 'alpha 0.01, beta 1', 'alpha 0.01, beta 10'), c('in_sample_nmi', 'out_of_sample_nmi'), c('in-sample NMI', 'out-of-sample NMI'))
#plot.experiments('29-a0.1', c('diff3'), c('29-a0.1-b0.001', '29-a0.1-b0.01', '29-a0.1-b0.1', '29-a0.1-b1', '29-a0.1-b10'), c('alpha 0.1, beta 0.001', 'alpha 0.1, beta 0.01', 'alpha 0.1, beta 0.1', 'alpha 0.1, beta 1', 'alpha 0.1, beta 10'), c('in_sample_nmi', 'out_of_sample_nmi'), c('in-sample NMI', 'out-of-sample NMI'))
#plot.experiments('29-a1', c('diff3'), c('29-a1-b0.001', '29-a1-b0.01', '29-a1-b0.1', '29-a1-b1', '29-a1-b10'), c('alpha 1, beta 0.001', 'alpha 1, beta 0.01', 'alpha 1, beta 0.1', 'alpha 1, beta 1', 'alpha 1, beta 10'), c('in_sample_nmi', 'out_of_sample_nmi'), c('in-sample NMI', 'out-of-sample NMI'))
#plot.experiments('29-a10', c('diff3'), c('29-a10-b0.001', '29-a10-b0.01', '29-a10-b0.1', '29-a10-b1', '29-a10-b10'), c('alpha 10, beta 0.001', 'alpha 10, beta 0.01', 'alpha 10, beta 0.1', 'alpha 10, beta 1', 'alpha 10, beta 10'), c('in_sample_nmi', 'out_of_sample_nmi'), c('in-sample NMI', 'out-of-sample NMI'))
plot.experiments('30', c('diff3'), c('30-rs1k', '30-rs10k', '30-rs100k', '30-rs500k'), c('reservoir size 1k', 'reservoir size 10k', 'reservoir size 100k', 'reservoir size 500k'), c('in_sample_nmi', 'out_of_sample_nmi'), c('in-sample NMI', 'out-of-sample NMI'))
