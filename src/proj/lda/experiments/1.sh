...
do
    ...
    bash run_pf_qsub_wrapper.sh $dataset_path $dataset_name 1-rs0 \
    ...
    bash run_pf_qsub_wrapper.sh $dataset_path $dataset_name 1-rs10 \
        "-q text.q -t 1-30 -tc 2 -l num_proc=1,mem_free=200M,h_rt=1:00:00" \
        "--reservoir_size=10 --init_num_docs=$init_num_docs --init_num_iters=$init_num_iters"
    bash run_pf_qsub_wrapper.sh $dataset_path $dataset_name 1-rs100 \
        "-q text.q -t 1-30 -tc 2 -l num_proc=1,mem_free=200M,h_rt=1:00:00" \
        "--reservoir_size=100 --init_num_docs=$init_num_docs --init_num_iters=$init_num_iters"
    bash run_pf_qsub_wrapper.sh $dataset_path $dataset_name 1-rs1k \
        "-q text.q -t 1-30 -tc 2 -l num_proc=1,mem_free=200M,h_rt=1:00:00" \
        "--reservoir_size=1000 --init_num_docs=$init_num_docs --init_num_iters=$init_num_iters"
    bash run_pf_qsub_wrapper.sh $dataset_path $dataset_name 1-rs10k \
    ...
    bash run_pf_qsub_wrapper.sh $dataset_path $dataset_name 1-rs100k \
    ...
    bash run_pf_qsub_wrapper.sh $dataset_path $dataset_name 1-rs500k \
