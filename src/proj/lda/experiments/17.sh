...
do
    ...
    bash run_pf_qsub_wrapper.sh $dataset_path $dataset_name 17-rs0 \
    ...
    bash run_pf_qsub_wrapper.sh $dataset_path $dataset_name 17-rs100k \
    ...
    bash run_pf_qsub_wrapper.sh $dataset_path $dataset_name 17-rs500k \
