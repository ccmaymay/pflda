...
do
    ...
    bash run_pf_qsub_wrapper.sh $dataset_path $dataset_name 18-rs0 \
    ...
    bash run_pf_qsub_wrapper.sh $dataset_path $dataset_name 18-rs100k \
    ...
    bash run_pf_qsub_wrapper.sh $dataset_path $dataset_name 18-rs500k \
