...
do
    ...
    bash qsub.sh $dataset_path $dataset_name 19-rs0 \
    ...
    bash qsub.sh $dataset_path $dataset_name 19-rs100k \
    ...
    bash qsub.sh $dataset_path $dataset_name 19-rs500k \
