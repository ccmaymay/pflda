...
do
    ...
    bash run_pf_qsub_wrapper.sh $dataset_path $dataset_name 21-rs0 \
    ...
    bash run_pf_qsub_wrapper.sh $dataset_path $dataset_name 21-rs10 \
        "-q text.q -tc 2 -l num_proc=1,mem_free=200M,h_rt=1:00:00" \
        "--reservoir_size=10 --init_num_docs=$init_num_docs --init_num_iters=$init_num_iters"
    bash run_pf_qsub_wrapper.sh $dataset_path $dataset_name 21-rs100 \
        "-q text.q -tc 2 -l num_proc=1,mem_free=200M,h_rt=1:00:00" \
        "--reservoir_size=100 --init_num_docs=$init_num_docs --init_num_iters=$init_num_iters"
    bash run_pf_qsub_wrapper.sh $dataset_path $dataset_name 21-rs1k \
        "-q text.q -tc 2 -l num_proc=1,mem_free=200M,h_rt=1:00:00" \
        "--reservoir_size=1000 --init_num_docs=$init_num_docs --init_num_iters=$init_num_iters"
    bash run_pf_qsub_wrapper.sh $dataset_path $dataset_name 21-rs10k \
    ...
    bash run_pf_qsub_wrapper.sh $dataset_path $dataset_name 21-rs100k \
    ...
    bash run_pf_qsub_wrapper.sh $dataset_path $dataset_name 21-rs500k \
