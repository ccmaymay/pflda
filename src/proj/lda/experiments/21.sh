...
do
    ...
    bash qsub.sh $dataset_path $dataset_name 21-rs0 \
    ...
    bash qsub.sh $dataset_path $dataset_name 21-rs100k \
    ...
    bash qsub.sh $dataset_path $dataset_name 21-rs500k \
