...
bash qsub.sh $dataset_path $dataset_name 28-rs50000-rss5000 \
    "-q text.q -tc 4 -l num_proc=1,mem_free=2G,h_rt=48:00:00" \
...
bash qsub.sh $dataset_path $dataset_name 28-rs100000-rss10000 \
    "-q text.q -tc 4 -l num_proc=1,mem_free=2G,h_rt=48:00:00" \
...
bash qsub.sh $dataset_path $dataset_name 28-rs500000-rss50000 \
    "-q text.q -tc 4 -l num_proc=1,mem_free=4G,h_rt=48:00:00" \
