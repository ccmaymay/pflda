...
bash run_pf_qsub_wrapper.sh ../../../data/txt/gigaword null 32-p10-t50-rs1k-rss100-a0.1-b0.1 \
    "-q text.q -t 1-5 -tc 2 -l num_proc=1,mem_free=3G,h_rt=72:00:00" \
...
bash run_pf_qsub_wrapper.sh ../../../data/txt/gigaword null 32-p1-t50-rs10k-rss1k-a0.1-b0.1 \
    "-q text.q -t 1-5 -tc 2 -l num_proc=1,mem_free=3G,h_rt=72:00:00" \
...
bash run_pf_qsub_wrapper.sh ../../../data/txt/gigaword null 32-p1-t50-rs1k-rss10-a0.1-b0.1 \
    "-q text.q -t 1-5 -tc 2 -l num_proc=1,mem_free=3G,h_rt=72:00:00" \
...
bash run_pf_qsub_wrapper.sh ../../../data/txt/gigaword null 32-p1-t50-rs1k-rss10-a0.1-b0.01 \
    "-q text.q -t 1-5 -tc 2 -l num_proc=1,mem_free=3G,h_rt=72:00:00" \
...
bash run_pf_qsub_wrapper.sh ../../../data/txt/gigaword null 32-p1-t50-rs1k-rss10-a0.01-b0.1 \
    "-q text.q -t 1-5 -tc 2 -l num_proc=1,mem_free=3G,h_rt=72:00:00" \
...
bash run_pf_qsub_wrapper.sh ../../../data/txt/gigaword null 32-p1-t50-rs1k-rss10-a0.01-b0.01 \
    "-q text.q -t 1-5 -tc 2 -l num_proc=1,mem_free=3G,h_rt=72:00:00" \
...
bash run_pf_qsub_wrapper.sh ../../../data/txt/gigaword null 32-p1-t100-rs1k-rss100-a0.1-b0.1 \
    "-q text.q -t 1-5 -tc 2 -l num_proc=1,mem_free=3G,h_rt=72:00:00" \
...
bash run_pf_qsub_wrapper.sh ../../../data/txt/gigaword null 32-p1-t50-rs1k-rss100-a0.1-b0.1 \
    "-q text.q -t 1-5 -tc 2 -l num_proc=1,mem_free=3G,h_rt=72:00:00" \
...
bash run_pf_qsub_wrapper.sh ../../../data/txt/gigaword null 32-p1-t10-rs1k-rss100-a0.1-b0.1 \
    "-q text.q -t 1-5 -tc 2 -l num_proc=1,mem_free=3G,h_rt=72:00:00" \
