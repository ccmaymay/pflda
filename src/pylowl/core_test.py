...
def chisq_1_test():
    assert_almost_equal(_chisq([3], [3]), 0.0)

def chisq_2_test():
    assert_almost_equal(_chisq([1], [3]), 4.0)

def chisq_3_test():
    assert_almost_equal(_chisq([3], [1]), 4.0 / 3.0)

def chisq_4_test():
    assert_almost_equal(_chisq([1, 3, 5], [1, 3, 5]), 0.0)

def chisq_5_test():
    assert_almost_equal(_chisq([5, 3, 1], [1, 3, 5]), 16.0 / 5.0 + 16.0)

def chisq_6_test():
    assert_almost_equal(_chisq([1, 3, 5], [5, 3, 1]), 16.0 / 5.0 + 16.0)

def chisq_7_test():
    assert_almost_equal(_chisq([2, 4, 6], [1, 3, 5]), 0.25 + 0.5 + 1.0 / 6.0)
