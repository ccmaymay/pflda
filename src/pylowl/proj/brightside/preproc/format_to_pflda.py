...
def format_to_indexed(train_input_filename, test_input_filename, train_output_filename, test_output_filename, stop_list=None, dictionary=None, idf_lb=0., idf_ub=1., remove_non_alpha=False, lowercase=False, min_word_len=1, log_level='INFO'):
